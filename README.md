...
- `GET /` renders all haikus.
- `GET /:id` renders a specific haiku by index.
- `GET /random` renders one random haiku and photo.
- `POST /random` renders one random haiku and photo.
